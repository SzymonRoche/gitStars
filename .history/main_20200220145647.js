...
const DisplayLogin = awaituserName.innerHTML = login;
const DisplayProject = awai projectsCounts.innerHTML = projectCounts;
const DisplayStars = awai starts.innerHTML("NEW starts";) 
